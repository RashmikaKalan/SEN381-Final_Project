    ...
    public partial class frmClientPurchaseMain : Form
    {
        ...
        private void bgwProgressComplete(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                dgvDisplay.Columns["ClientName"].DisplayIndex = 1;
                dgvDisplay.Columns["ProdName"].DisplayIndex = 2;
                dgvDisplay.Columns["Version"].DisplayIndex = 3;
                dgvDisplay.Columns["Cost"].DisplayIndex = 4;
                dgvDisplay.Columns["Date"].DisplayIndex = 5;
                dgvDisplay.Columns["ClientID"].DisplayIndex = 0;
