    ...
    public partial class frmTechnicalMain : Form
    {
        ...
        private void bgwProgressComplete(object sender, RunWorkerCompletedEventArgs e)
        {
            try
            {
                ...
                dgvDisplay.Columns["EmpName"].Visible = false;
                dgvDisplay.Columns["ClientName"].Visible = false;
        ...
        private void appointmentProgressToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
                frmAppointmentProgress fra = new frmAppointmentProgress();
                fra.Show();
                this.Hide();
            }
            catch (Exception ex)
        ...
        private void appointmentsByPriorityToolStripMenuItem_Click(object sender, EventArgs e)
        {
            try
            {
