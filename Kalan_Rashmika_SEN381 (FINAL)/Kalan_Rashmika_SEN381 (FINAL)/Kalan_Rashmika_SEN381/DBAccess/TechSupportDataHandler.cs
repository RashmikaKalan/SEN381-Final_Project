...
namespace DBAccess
{
    public class TechSupportDataHandler
    {
        ...
        public void AddAppointment(int bookID, int empID, string clientID, string desc, DateTime date, string priority)
        {
            SqlConnection connection = new SqlConnection(conn.ToString());
            try
            {
        ...
        public void UpdateAppointment(int bookID, int empID, string clientID, string desc, DateTime date, string priority)
        {
            SqlConnection connection = new SqlConnection(conn.ToString());
            try
            {
